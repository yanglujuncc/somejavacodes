...
public class firstTestBDB {
    ...
    public firstTestBDB(int numRecords,
                         boolean doInsert,
                         File envDir,
                         int offset) {
    ...
    public static void main(String argv[]) {
        ...
        try {
        	firstTestBDB app = new firstTestBDB(numRecordsVal,
                                                  doInsertArg,
                                                  envHomeDirectory,
                                                  startOffset);
            app.run();
    ...
    public void run() throws DatabaseException {
        ...
        if (doInsert) {
            ...
            for (int i = offset; i < numRecords + offset; i++) {
                ...
                exampleDb.get(null, keyEntry, dataEntry, LockMode.DEFAULT);
