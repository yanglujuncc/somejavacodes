...
public class MutiTheadHttpHandler implements HttpHandler {
	...
	HttpExchangeHandler exchangeHandler;
	
	public MutiTheadHttpHandler(int threadNum,int maxThreadNum,int taskQueueSize,HttpExchangeHandler exchangeHandler){
    ...
    public  class ExchangeTask implements Runnable{  
       ...
       public   ExchangeTask(HttpExchange xchg,int taskID) {  
        ...
        public void run() {  
        	...
        	try {
				 ...
				 exchangeHandler.handleExchange(xchg);
     ...
     public  static class  SampleHttpExchangeHandler implements HttpExchangeHandler{
